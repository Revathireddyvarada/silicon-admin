...
@Entity("vehicle_document_types")
export class VehicleDocumentType {
  ...
  @ManyToOne(() => VehicleDocumentType, (doc) => doc.children, {
    onDelete: "CASCADE",
    nullable: true,
  })
  @JoinColumn({ name: "parent_id" })
  parent?: VehicleDocumentType | null;

  @OneToMany(() => VehicleDocumentType, (doc) => doc.parent)
  children?: VehicleDocumentType[];
